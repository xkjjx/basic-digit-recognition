...
from common import augment_with_rotations, create_cnn_model, generate_model_filename, load_mnist_images, load_mnist_labels
...
def main():
    ...
    save_path = args.save_path or generate_model_filename("cnn", args.epochs, args.lr, args.batch_size, args.scheduler, args.num_rotations)
